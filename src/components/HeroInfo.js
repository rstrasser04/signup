...
const HeroInfo = () => (
   <div className="hero-container">
      ...
      <h3>Register for the Education Seminar</h3>
         <p>
            We are better together. Join your Fiserv experts and peers for interactive presentations and discussions that provide the necessary insight to become more efficient. Use this face-to-face venue to learn more about the software you use every day and share your best practices and software tips all while building a diverse network of professional relationships.
         </p>
         <p>
            Precision Education Seminars are one and one-half days interactive sessions that provide the ideal setting to gain new perspectives and make valuable connections with peers and Fiserv experts.
         </p>
      <h2>Fees</h2>
